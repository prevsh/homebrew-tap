class Prev < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/prevsh/apt/releases/download/v1.9.4/prev-darwin-arm64"
      sha256 "ae29b8a87a9c9b0b2d783f8b8e39de72c6e02be9266d1670a8ef3f8f4c898dfc"
    else
      url "https://github.com/prevsh/apt/releases/download/v1.9.4/prev-darwin-amd64"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/prevsh/apt/releases/download/v1.9.4/prev-linux-arm64"
      sha256 "149bc4ae6e2604bedc55020df47068a17f10f30b367bc094669bcfe40904f575"
    else
      url "https://github.com/prevsh/apt/releases/download/v1.9.4/prev-linux-amd64"
